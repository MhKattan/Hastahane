...
namespace hastakayit
{
    public partial class Form1 : Form
    {
        ...
        {
            SqlConnection con =new SqlConnection("Data Source=DESKTOP-41M6AUQ\\SQLEXPRESS;Initial Catalog=hastane;Integrated Security=True");
            ...
            {
                MessageBox.Show("Giriş Başarılsız");
            }
